...
The log-bias seems to have some heavy tails, but it is generally between -2 and 2, as our prior states. There seems to be a slight negative bias (in direction of reference), which makes sense.
```{r}
